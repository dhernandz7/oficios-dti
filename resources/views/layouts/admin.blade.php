      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="cards.html">Addendums</a>
            <a class="collapse-item" href="buttons.html">Dictamenes</a>
            <a class="collapse-item" href="buttons.html">Oficios</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
